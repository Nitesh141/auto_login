...
def func():
    usr = ["pp19@iitbbs.ac.in", "ss55@iitbbs.ac.in", "gs15@iitbbs.ac.in", "jm11@iitbbs.ac.in", "mm11@iitbbs.ac.in",
           "rs15@iitbbs.ac.in", "sr16@iitbbs.ac.in", "ss29@iitbbs.ac.in", "nk14@iitbbs.ac.in", "sv14@iitbbs.ac.in"]
    pwd = ["pp19.pp19.pp19", "ss55.ss55.ss55", "gs15.gs15.gs15", "260799", "260799", "260799", "260799", "260799",
           "ss55pp19gs15", "xiaomi98"]
...
class MainFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        panel = wx.Panel(self, wx.ID_ANY, size=(3000, 3000))
        panel.SetBackgroundColour(wx.Colour(0, 0, 255))
        button = wx.Button(panel, wx.ID_ANY, 'Test', (150, 70))
